...
export default function Hero() {
  return (
    <section className=' bg-cover bg-no-repeat bg-center' style={{backgroundImage: "url('/images/bgedfg.png')"}}>
        <div className='flex flex-col items-center py-7 px-5 pb-14  lg:flex-row-reverse justify-between lg:max-w-[1100px] mx-auto overflow-hidden lg:h-screen'>
          <CoffeeSwiper/>
